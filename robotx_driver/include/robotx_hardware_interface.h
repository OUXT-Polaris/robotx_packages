...
private:
    ...
    ros::NodeHandle nh_;
    /**
     * @brief ROS subscriber for /wam_v/motor_command topic.(message type : std_msgs/Float64MultiArray)
     * 
     */
    ros::Subscriber motor_command_sub_;
    /**
     * @brief ROS subscriber for /fix topic.(message type : sensot_msgs/NavSatFix)
     * 
     */
    ros::Subscriber fix_sub_;
    /**
     * @brief ROS subscriber fot /current_task_number topic.(message type : std_msgs/uint8)
     * 
     */
    ros::Subscriber current_task_number_sub_;
    /**
     * @brief ROS publisher for /cmd_drive topic.(message type : robotx_msgs/UsvDrive)
     * 
     */
    ros::Publisher usv_drive_cmd_pub_;
    /**
     * @brief ROS publisher for /left_thruster_position_controller/command topic.(message type : std_msgs/Float64)
     * 
     */
    ros::Publisher left_thrust_joint_pub_;
    /**
     * @brief ROS publisher for /right_thruster_position_controller/command topic.(message type : std_msgs/Float64)
     * 
     */
    ros::Publisher right_thrust_joint_pub_;
    /**
     * @brief ROS publisher for ~/heartbeat topic.(message type : robotx_msgs/Heartbeat)
     * 
     */
