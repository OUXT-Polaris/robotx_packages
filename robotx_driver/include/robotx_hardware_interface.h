...
class robotx_hardware_interface {
   public:
    struct parameters {
         ...
         */
        parameters() {
            ros::param::param<int>(ros::this_node::getName() + "/target",
                                   target, ALL);
            ros::param::param<int>(ros::this_node::getName() + "/init_mode",
                                   init_mode, REMOTE_OPERATED);
            ros::param::param<int>(ros::this_node::getName() + "/timeout",
                                   timeout, 30);
            ...
            ros::param::param<std::string>(
                ...
                "127.0.0.1");
            ros::param::param<int>(
                ros::this_node::getName() + "/left_motor_port", left_motor_port,
                50000);
            ros::param::param<int>(
                ros::this_node::getName() + "/right_motor_port",
                right_motor_port, 50001);
            ros::param::param<std::string>(
                ros::this_node::getName() + "/team_id", team_id,
                "OUXT Polaris");
        };
    };
