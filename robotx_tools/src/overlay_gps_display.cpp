...
OverlayGpsDisplay::OverlayGpsDisplay() {
  ...
  width_property_ =
      new rviz::IntProperty("Width", 320, "request map image width", this, SLOT(updateGooleMapAPIProperty()));
...
bool OverlayGpsDisplay::build_request_url(const sensor_msgs::NavSatFix::ConstPtr& msg,
  ...
  */
  ...
  std::string size_request =
      "&size=" + std::to_string(width_property_->getInt()) + "x" + std::to_string(height_property_->getInt());
