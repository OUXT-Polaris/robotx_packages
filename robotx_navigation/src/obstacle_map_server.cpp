...
void obstacle_map_server::objects_bbox_callback_(jsk_recognition_msgs::BoundingBoxArray msg)
{
    ...
    //nav_msgs::OccupancyGrid map = generate_occupancy_grid_map_(msg);
}
...
nav_msgs::OccupancyGrid obstacle_map_server::generate_occupancy_grid_map_(jsk_recognition_msgs::BoundingBoxArray msg)
{
    nav_msgs::OccupancyGrid map;
