...
robotx_map_server::robotx_map_server()
{
  map_width_ = 200;
  map_height_ = 200;
  map_resolution_ = 0.1;
  ...
  pointcloud_sub_ = nh_.subscribe(ros::this_node::getName()+"/input_cloud", 1, &robotx_map_server::pointcloud_callback, this);
}
...
void robotx_map_server::pointcloud_callback(sensor_msgs::PointCloud2 input_cloud)
{
...
void robotx_map_server::create_map_meta_data()
{
...
pcl::ModelCoefficients::Ptr robotx_map_server::segment_buoy(pcl::PointCloud<pcl::PointXYZ>::Ptr pcl_input_cloud)
{
...
void robotx_map_server::input_map_data(std::vector<pcl::ModelCoefficients::Ptr> coefficients_buoy)
{
